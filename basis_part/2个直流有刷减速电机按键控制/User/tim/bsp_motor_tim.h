...
/*PWM引脚*/
#define PWM2_TIM_CH1_GPIO_CLK()          __HAL_RCC_GPIOB_CLK_ENABLE();
#define PWM2_TIM_CH1_GPIO_PORT           GPIOB
#define PWM2_TIM_CH1_PIN                 GPIO_PIN_6

#define PWM2_TIM_CH2_GPIO_CLK()          __HAL_RCC_GPIOB_CLK_ENABLE();
#define PWM2_TIM_CH2_GPIO_PORT           GPIOB
